...
5. **内容合规检测（两道闸）**：文本层扫正文/标题/标签；图生成后再扫「图上印的字」，P0 红线拦截（AIGC 标识/虚假体验/违禁词/站外导流等），P1 风险标注。
...
- **P0（9 类红线）**：⭐AIGC 未标识 / ⭐虚假体验·虚构人设 / 诱导互动 / 免费送福利 / 互赞互关 / 违禁词·极限词 / 站外导流 / 批量问答 / 垂类准入（医疗医美·金融·教培·烟酒）→ 命中必改
- **P1（8 类风险）**：软引导互动 / 模糊功效·无对比 / 贬低竞品 / 敏感话题·制造对立 / 外部提及 / 软广特征 / 标题党·文题不符 / 炫富夸大 → 同样命中必改

> 本工具产出 AI 内容，**P0-1 AIGC 标识** 是 2026 头号红线：`compliance.ai_disclosure` 须非空、正文带 AI 声明，发布时勾选【内容类型声明→笔记包含 AI 合成内容】。
